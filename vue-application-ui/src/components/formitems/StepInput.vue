<template>
    <div style="overflow-x: scroll;margin:10px">
       
    <ol class="flex items-center w-full mb-4 sm:mb-5">

    <li v-for="repp in rep+1" class="flex w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-blue-100 after:border-4 after:inline-block dark:after:border-blue-800">
        <div @click="changePage(repp)" class="flex items-center justify-center w-10 h-10 bg-blue-100 rounded-full lg:h-12 lg:w-12 dark:bg-blue-800 shrink-0"> {{ repp }} </div>
    </li>
...
export default {
    ...
    props: {
        ...
        steps: {type:Array, default:[{id:1,title:""},{id:2,title:""}]}
