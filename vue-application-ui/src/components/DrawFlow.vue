<template>
    ...
    <el-container>
      <el-header class="header">
          <h3 class="text-3xl font-bold dark:text-white">Workflow Builder</h3>
    ...
    import Node1 from './nodeitems/Node1.vue'
    import Node2 from './nodeitems/Node2.vue'
    import Node3 from './nodeitems/Node3.vue'
